...
#include "GradworkProjectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class GRADWORKPROJECT_API AGradworkProjectOffroadCar : public AGradworkProjectPawn
{
	GENERATED_BODY()
